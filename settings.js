...
//              ███████║██║╚██████TRAILBLAZER TECH╔╝        TRAILBLAZER TECH                 //
...
* @project_name : TRAIBLAZER TECHMD

* @Developer : Trailblazer 
...
global.github    = 'https://github.com/Trailblazer/TRAILBLAZER TEC- MD' ;

global.location  = 'Lahore, Pakistan' ;

global.website   = 'https://maher-trailblazer.tech' ; 
...
global.owner = process.env.OWNER_NUMBER  || '254758462960' ;  // ADD YOUR NUMBER WITHOUT +

global.mongodb = process.env.MONGODB_URI || "" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN

global.timezone  = process.env.TIME_ZONE || 'Nairobi/Kenya' // ADD CORRECT TIMEZONE OR LEAVE IT SAME , OTHERWISE YOU GET ERROS
...
global.mztit = process.env.MZTIT ||"TR♥︎AIL♥︎BLA💸🆉ER",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
